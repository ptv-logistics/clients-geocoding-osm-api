...
namespace PTV.Developer.Clients.geocoding_osm.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://api.myptv.com/geocoding-osm/v1";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://api.myptv.com/geocoding-osm/v1"},
        ...
        public Configuration(
            ...
            string basePath = "https://api.myptv.com/geocoding-osm/v1") : this()
        {
        ...
        {
            string report = "C# SDK (PTV.Developer.Clients.geocoding_osm) Debug Report:\n";
